...
- ✅ Score now persists across rounds
- ✅ Removed duplicate game displays
- ✅ Fixed redundant calculate function calls
- ✅ Added proper invalid input handling
- ✅ Winner correctly becomes option A in next round
