...
start_btn = Button(text="Start", cursor="plus", command=start_timer)
start_btn.grid(column=0, row=2)
reset_btn = Button(text="Reset", cursor="plus", command=reset_timer)
reset_btn.grid(column=2, row=2)

mark_label = Label(text="", font=(FONT_NAME,10,"bold"), bg=YELLOW, fg=PINK)
